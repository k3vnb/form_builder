...
export const TextInput = ({
  ...
  const showInvalidIcon = React.useMemo(() => (!disabled && invalid), [touched, invalid]);
...
const styles = {
  ...
  disabled: 'bg-gray-50 text-gray-500 placeholder:text-gray-400 ring-gray-300 cursor-not-allowed cursor-not-allowed opacity-50'
}
